        ...
        <>
            <div className='w-fit ml-10 bottom-40 absolute'>
                ...
                <a
                    ...
                    className='w-fit bg-white text-black px-6 py-3 rounded-sm mybold text-xl flex hover:bg-gray-300 transition duration-300 cursor-pointer'
                >
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        viewBox="0 0 330 330" style={{ enableBackground: 'new 0 0 330 330' }} xmlSpace="preserve" className='w-6 h-6 mr-2 align-center my-auto'>
